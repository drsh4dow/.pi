---
name: beauty-gate
description: Beauty gate — a behavior-preserving audit of the full diff after an implementation works and before declaring it complete. Use when a change has just gone green, when the user says "gate it", "audit this diff", or asks whether a change can be simplified or shrunk.
---
